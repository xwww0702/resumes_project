  ...
  () => {
    ...
    autoSaveTimer.value = setTimeout(() => {
      ...
      saveData(
        store.componentList,
        saveResume,
        resumeStore.currentResumeId,
        resumeStore.currentResumeTitle
      );
...
<template>
  <el-menu
    class="h-14 bg-white border-b border-gray-200 flex items-center px-4"
    mode="horizontal"
    :ellipsis="false"
    text-color="#303133"
    router
  >
    ...
    <div class="flex items-center gap-3 ml-4">
      ...
      <el-button
        ...
        class="flex items-center"
        :disabled="!route.query.id"
        @click="exportJSON(store.componentList)"
      >
        <span>导出 JSON</span>
      </el-button>
    ...
    <router-link to="/myResume" role="none">
